...
const EpisodeCard = ({ episode, animeId }: EpisodeCardProps) => {
  ...
  return (
    <Link href={`/watch/${animeId}/${episode.id}`}>
      <div className="bg-dark-800/60 rounded-lg overflow-hidden hover:bg-dark-700/60 transition-all duration-300 cursor-pointer group border border-dark-700/30 hover:border-primary/20 hover:scale-[1.02]">
        <div className="relative">
          ...
          <div className="absolute top-2 left-2 bg-dark-900/70 text-white text-xs px-2 py-1 rounded backdrop-blur-sm">
        ...
        <div className="p-3">
          <h3 className="font-medium text-sm mb-1 line-clamp-1 group-hover:text-primary transition-colors duration-300">{episode.title}</h3>
