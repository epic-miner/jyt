        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-4">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex space-x-4 items-center">
              ...
              <a href="https://t.me/nineanimeofchat" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors bg-primary/10 p-2 rounded-full">
